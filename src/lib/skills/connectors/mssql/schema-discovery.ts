...
const skill: SkillDefinition<ConnectorSchemaDiscoverInput, ConnectorSchemaDiscoverOutput> = {
  id: "connector.mssql.schema-discovery",
  description: "Connector-specific schema discovery operations for MSSQL.",
  run: async (input) => {
    try {
...
export function registerMssqlSchemaDiscoverySkill() {
